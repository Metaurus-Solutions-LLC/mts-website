         ...
         <div  className="page">
           <div  className="topic-container"> {/* topic-container */}
             ...
             <div  className="w-8/12 md:w-10/12 md:max-w-2xl"> {/* topic-image */}
               <img src={schedule} alt="project schedule on computer screen" />
             </div>  
           </div>
           ...
           <div> {/* topic-question */}
             <h2  className="text-[darkred] mt-8 mx-16 my-4">How can a repeatable, adaptable planning approach help your business achieve its objectives?</h2>
           </div>  
